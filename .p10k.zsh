# Generated by Powerlevel10k configuration wizard on 2020-12-20 at 16:24 +04.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 33302.
...
() {
  ...
  # in each pair defines a patern against which the current AWS profile gets matched.
  # More specifically, it's P9K_CONTENT prior to the application of context expansion (see below)
